...
def print_results(results_dic, results_stats_dic, model, 
    ...
    if (print_incorrect_dogs and 
        ...
        for key in results_dic:
            ...
            str_ = "{}{}".format(results_dic[key][0], results_dic[key][1])
            if results_dic[key][3] == 1 and results_dic[key][4] == 0:
                print(str_, "is a Dog", "- Classified as ", "is NOT-A-Dog")
            elif results_dic[key][3] == 0 and results_dic[key][4] == 1:
                print(str_, "is NOT a Dog", "- Classified as ", "a-Dog")
